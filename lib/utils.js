...
var safeBase58 = require('./safe-base58');
 ...
 **/
var addressBase58Prefix = null;
var integratedAddressBase58Prefix = null;
var subAddressBase58Prefix = "N/A";

if (config.poolServer && config.poolServer.poolAddress) {
    var addressBase58PrefixBuffer = safeBase58.address_decode(Buffer.from(config.poolServer.poolAddress));
    addressBase58Prefix = addressBase58PrefixBuffer ? addressBase58PrefixBuffer[0] : null;
    integratedAddressBase58Prefix = config.poolServer.intAddressPrefix ? parseInt(config.poolServer.intAddressPrefix) : (addressBase58Prefix ? addressBase58Prefix + 1 : null);
    subAddressBase58Prefix = config.poolServer.subAddressPrefix ? parseInt(config.poolServer.subAddressPrefix) : "N/A";
}
...
function getAddressPrefix(address) {
    ...
    var addressPrefix = safeBase58.address_decode(addressBuffer);
